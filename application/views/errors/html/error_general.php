...
<head>
	<meta charset="utf-8" />
	<title>Terjadi Kesalahan - <?= config_item('APP_name'); ?></title>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-12 text-center">
					...
					<a href="<?php $actualLink = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
								echo $actualLink;
								?>" class="btn btn-lg btn-primary mt-4">Kembali</a>
				</div>
			</div>
		</div>
		<!-- end container -->
